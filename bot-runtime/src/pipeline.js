...
## 요구사항 (분량 — 가장 중요)
- **장수 제한 없음. 내용이 다 들어가는 게 우선.**
- **소스 본문의 모든 핵심 데이터·시사점·수치를 빠짐없이 포함할 것. 축약/요약/생략 금지.**
- 대주제(H1 챕터)마다 필요한 만큼 슬라이드 생성. 20장이 필요하면 20장.
- 소스에 있는 숫자, 퍼센트, 사례가 카피에 빠지면 실패.
- 완성 후 스스로 본문과 대조해서 빠진 내용이 없는지 검증.
